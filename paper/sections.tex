...
crash pre-condition is given as a condition on the heap $P /\ CP$, but
under the rule of inference ``material implication,''
we can see that $P /\ CP$ corresponds to $\not (P \implies \not CP)$,
...
$P /\ CP$, we expect that $P$ and $CP$ must share a heap footprint.
